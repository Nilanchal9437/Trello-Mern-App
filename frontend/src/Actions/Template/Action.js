import { TEMPLATE_NAME, TEMPLATE_DESIGN1, TEMPLATE_DESIGN2, TEMPLATE_LIST, TEMPLATE_DISPLAY,FRAME_INDEX, DELETE_TEMPLATE, REMOVE_RECENT_ITEMS, RECENT_VIEW } from '../../Constants/Template/contants';


export const setRecent = () => {
    return {
        type: RECENT_VIEW
    }
}
