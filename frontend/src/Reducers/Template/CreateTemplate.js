import { TEMPLATE_NAME, TEMPLATE_DESIGN1, TEMPLATE_DESIGN2, TEMPLATE_LIST, TEMPLATE_DISPLAY, FRAME_INDEX, DELETE_TEMPLATE, RECENT_VIEW, REMOVE_RECENT_ITEMS } from '../../Constants/Template/contants';
import { LIST_TITLE, CREATE_LIST, DELETE_LIST, UPDATE_LIST_ACESS, UPDATE_LIST } from '../../Constants/List/ListConstant';
import { CARD_TITLE, CARD_BODY, CARD_COLOR, CARD_IMAGE, CREATE_CARD, LIST_INDEX, DELETE_CARD, CARD_DELETE_INDEX, CARD_UPDATE, CARD_ID } from '../../Constants/Card/CardConstants';
import { DRAG_LIST_ID, DROP_LIST_ID, CARD_DRAG_ID, CARD_DROP_ID, DND_RESTORE, TEMOPORARY_LIST } from '../../Constants/DND/DNDConstants';
import { TRELLO_ARRAY } from "../../Constants/API/ApiConstants";
...
export default function CreateTemplates(state = TemplateData, action) {
    switch (action.type) {
        ...
        case REMOVE_RECENT_ITEMS:
            state.tempList[state.frameIndex]['RECENT'] = false;
            return {
                ...state
            }
        case RECENT_VIEW:
            state.tempList[state.frameIndex]['RECENT'] = true;
            return {
                ...state
            }
        ...
        case CREATE_LIST:
            state.tempList[state.frameIndex].LIST.push({ 
                LISTNAME: state.listTitle, 
                CARDITEMS: []
            });
            return {
                ...state,
        ...
        case CREATE_CARD:
            ...
            state.tempList[state.frameIndex]['CARD_ID'] = state.cardCeateIndex;
            return {
                ...state,
            }
        case CARD_ID:
            return {
                ...state,
                cardCeateIndex: action.cardCeateIndex
            }
        case DRAG_LIST_ID:
            return {
                ...state,
